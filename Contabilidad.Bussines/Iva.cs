...
namespace Contabilidad.Bussines
{
    public class Iva
    {
        ...
        #region IvaNoAcreditar
        public string IvaNoAcreditar(int intCuentaBancaria, string intMes, string intEjercicio, int intEmpresa)
        {
            string value = "usp_IVA_Acreditar_Rep_V2 ";
            value = value + intEmpresa.ToString() + ",";
            value = value + intMes.ToString() + ",";
            value = value + intEjercicio.ToString() + ",";
            value = value + intCuentaBancaria.ToString();
