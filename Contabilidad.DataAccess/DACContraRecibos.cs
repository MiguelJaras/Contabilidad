...
{
    public class DACContraRecibos:Base
    {
        #region Save
        public static string Save(Entity_ContraRecibos obj)
        {
            string result = "";
            ...
            arrPar[8] = new SqlParameter("@intContraRecibo", SqlDbType.Int);
            arrPar[8].Value = obj.IntContraRecibo;
            ...
            try
            {
                result = SqlHelper.ExecuteScalar(ConnectionString, CommandType.StoredProcedure, "VetecMarfilAdmin..usp_tbGeneracionCR_Save", arrPar).ToString();
            }
            catch (Exception e)
            {
                throw e;
        ...
        #region Fill
        public static DataTable Fill(Entity_ContraRecibos obj)
        {
            ...
            try
            {
                dt = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "VetecMarfilAdmin..usp_tbGeneracionCR_Fill", arrPar);
                return dt.Tables[0];
            }
            catch (Exception e)
            {
