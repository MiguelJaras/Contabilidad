IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'dbo.usp_tbCuentasRet_Sel_')
	AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE dbo.usp_tbCuentasRet_Sel_
	PRINT N'Drop Procedure : dbo.usp_tbCuentasRet_Sel_ - Succeeded !!!'
END
GO
...
------------------------------------------------------------------------------------
CREATE PROCEDURE usp_tbCuentasRet_Sel_
(
	@intEmpresa					  INT,
	@intArea					  INT,
...
INSERT INTO #Temp_tbCuentasRet(intEmpresa,intArea,strNombreArea,strInsumoIni,NombreInsumoIni,strInsumoFin,NombreInsumoFin,strCuentaCargo,NombreCuentaCargo,strCuentaAbono,NombreCuentaAbono,NombreEstatus,intES)
 ...
 INNER JOIN tbCuentas CtaAbono
	...
	SELECT intEmpresa,intArea,strNombreArea,strInsumoIni,NombreInsumoIni,strInsumoFin,NombreInsumoFin,strCuentaCargo,NombreCuentaCargo,strCuentaAbono,NombreCuentaAbono,NombreEstatus,intES
	FROM #Temp_tbCuentasRet
...
IF (@@Error = 0)
BEGIN
	PRINT 'Procedure Creation: dbo.usp_tbCuentasRet_Sel_ Succeeded'
END
ELSE
BEGIN
	PRINT 'Procedure Creation: dbo.usp_tbCuentasRet_Sel_ Error on Creation'
END
GO