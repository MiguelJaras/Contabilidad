...
function VetecUtils(){
	...
	*/
    ...
    document.onkeydown = function (e) {
        ...
        if (evtobj.ctrlKey) __isCtrl = true;
	    //Guardar	    	    	    
        if ("G" == String.fromCharCode(evtobj.keyCode) && __isCtrl == true) {
	    ...
	    //Nuevo
        if ("N" == String.fromCharCode(evtobj.keyCode) && __isCtrl == true) {
	     ...
	     //Listado
        if ("L" == String.fromCharCode(evtobj.keyCode) && __isCtrl == true) {
	    ...
	    //Imprimir
        if ("I" == String.fromCharCode(evtobj.keyCode) && __isCtrl == true) {
	     ...
	     //Eliminar
        if ("E" == String.fromCharCode(evtobj.keyCode) && __isCtrl == true) {
