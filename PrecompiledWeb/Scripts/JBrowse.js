...
function JBrowse(p_strClave, p_strTexts, p_strBO, p_strParam, p_intVersion, p_intEmpresa, p_intSucursal, p_intLength, p_blRequerido, p_strMsg, p_function, p_IsQuery) {
    ...
    var CSTRDIRAYUDA = CSTRHOSTNAME + "Utils/Browse.aspx";
    window.open(CSTRDIRAYUDA + "?intEmpresa=" + p_intEmpresa + "&intSucursal=" + p_intSucursal + "&classname=" + p_strBO + strParams + "&version=" + p_intVersion + "&parametros=" + i + "&buscarpor=" + strCampoBusqueda + "&IsQuery=" + IsQuery, '', 'height=570,width=520;top=0 left=400;resizable:yes;scroll:yes;');
}
