        ...
        foreach (DevExpress.Web.ASPxGridView.GridViewColumn obj in ASPxGridViewAyuda.Columns)
        {
            switch (obj.GetType().Name)
            {
                case "GridViewDataTextColumn":
                    ...
                    if (obj.ToString().Contains("hdd"))
                    { 
                        //obj.Visible = false;


                        ASPxGridViewAyuda.Columns[obj.ToString().Replace(" ", "")].Width = Unit.Pixel(1);
                        obj.Width = Unit.Pixel(1);
                        ASPxGridViewAyuda.Columns[obj.ToString().Replace(" ", "")].HeaderStyle.CssClass = "hidden";
                        ASPxGridViewAyuda.Columns[obj.ToString().Replace(" ", "")].FooterCellStyle.CssClass = "hidden";
                        ASPxGridViewAyuda.Columns[obj.ToString().Replace(" ", "")].CellStyle.CssClass = "hidden";

                        bcol.EditCellStyle.CssClass = "hidden";
                        bcol.FilterCellStyle.CssClass = "hidden";
                        bcol.HeaderStyle.CssClass = "hidden";

                        bcol.FooterCellStyle.CssClass = "hidden";
                        bcol.CellStyle.CssClass = "hidden";
