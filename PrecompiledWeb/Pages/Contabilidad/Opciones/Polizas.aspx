<%@ Page Language="C#" MasterPageFile="Base.master"  MaintainScrollPositionOnPostback="true" CodeFile="Polizas.aspx.cs" Inherits="Administracion_Contabilidad_Polizas" culture="es-mx" uiculture="es" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHBase" Runat="Server">
            ...
            <tr style="height: 15px">
                ...
                <td>                                                                     
                    <anthem:TextBox ID="txtPoliza" runat="server" MaxLength="20" Width="100px" TabIndex="9" AutoCallBack="True" OnTextChanged="txtPoliza_TextChanged" CssClass="String">
                       ...
                       <anthem:ImageButton runat="server" ID="btnAyudaPoliza" OnClientClick="var a = JBrowse('ctl00_CPHBase_txtPoliza','ctl00_CPHBase_txtPoliza,ctl00_CPHBase_hddPoliza,ctl00_CPHBase_hddPoliza','DACPolizaDet','ctl00_CPHBase_cboTipoPoliza,ctl00_CPHBase_hddYear,ctl00_CPHBase_hddMonth',4,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHBase_txtPoliza').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
        ...
        <table width="100%">
            ...
            <tr>
             ...
             <anthem:ImageButton ID="btnPol" runat="server" CssClass="tdButton_Aqua" Style="display: none"
            Text="" />
        </table>        
	...
	<script type="text/javascript" language="javascript">							
	    ...
	    function ReturnAutorizacion(result) {
        ...
        function Copiar(poliza, intEjercicio, intTipo,intEmpresa)
	    {
            ...
            window.open(url, "", "height=250px width=610px resizable scrollbars");
        ...
        {       
           ...
           window.open(url, "", "height=600px width=610px resizable scrollbars");
