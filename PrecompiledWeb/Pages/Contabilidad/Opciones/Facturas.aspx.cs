...
public partial class Contabilidad_Compra_Opciones_Facturas : System.Web.UI.Page
{
    ...
    public void Digitalizacion()
    {
        ...
        string strDirectory = Server.MapPath("~/Temp/Facturas/");
        foreach (FileFactura file in vsListFileFactura)
        {
            ...
            if (fac.DocumentosSave(2, 7, intProspecto, 9, 214, bfile, strFileName, Contabilidad.SEMSession.GetInstance.StrUsuario, Contabilidad.SEMSession.GetInstance.StrMaquina) != "true")
            {
    ...
    protected void DgrdList_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            obj.intFactura = Convert.ToInt32(grdList.DataKeys[e.RowIndex].Values[2].ToString());
