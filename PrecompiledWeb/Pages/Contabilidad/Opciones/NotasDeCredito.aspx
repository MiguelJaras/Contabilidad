<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Base.master" CodeFile="NotasDeCredito.aspx.cs" Inherits="Contabilidad_Compra_Opciones_NotasDeCredito" culture="es-mx" uiculture="es" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="CPHBase" Runat="Server">      	       
     <script type="text/javascript" language="javascript">
		...
		function datosCompletos()
        {
		    ...
		    var Folio = $('#ctl00_CPHBase_txtFolio').val();
		    ...
		    if (Folio == '') {
		        alert('Favor de seleccionar un folio de factura.')
		        return false;
		    }

		    if (facturaPDF == '' || facturaXML == '') {
		        alert('Favor de seleccionar la nota de credito.')
		        return false;
		    }
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
       ...
       <%-- <tr>
           ...
           <td class="tLetra36" style="height: 23px">
                <anthem:TextBox ID="txtSerie" runat="server" Width="75px" BackColor="#FFFF80" CssClass="tDatos250" TabIndex="1">
                </anthem:TextBox>
            </td>
            <td class="tLetra3">
                &nbsp;
        ...
        <tr>
           ...
           <td class="tLetra36" style="height: 23px">
                <anthem:TextBox ID="txtFolio" runat="server" Width="75px" BackColor="#FFFF80" CssClass="tDatos250" TabIndex="1">
                </anthem:TextBox>
            </td>
            <td class="tLetra3">
                &nbsp;
            ...
            <td align="center">
                <div id="div-ListPanel">
                    <anthem:GridView ID="grdList" runat="server" AutoGenerateColumns="false" AutoUpdateAfterCallBack="true"
                        BorderWidth="0" CellPadding="0" CellSpacing="0" CssClass="dxgvTable_Aqua" DataKeyNames="intProspecto,intDocumento,intNotaCredito"
                        ...
                        <Columns>     
                            ...
                            <asp:BoundField DataField="Nota" SortExpression="Nota" HeaderText="Nota" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
			                </asp:BoundField>  
