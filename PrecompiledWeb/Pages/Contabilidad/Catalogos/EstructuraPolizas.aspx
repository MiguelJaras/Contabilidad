...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHBase" runat="Server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td class="tLetra3" valign="middle" style="width: 600px; height: 25px">
                <%--<anthem:TextBox ID="txtMovTo" runat="server" TabIndex="3" Width="80px" CssClass="String" ondblclick="var a = JBrowse('ctl00_CPHBase_txtMovTo','','DACEstructuraPolizaEnc','',1,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay Tipos de Movimiento',1); if(a != undefined) document.getElementById('ctl00_CPHBase_txtMovTo').onchange(); else return false;"--%>
                <anthem:TextBox ID="txtMovTo" runat="server" TabIndex="3" Width="80px" CssClass="String" ondblclick="var a = JBrowse('ctl00_CPHBase_txtMovTo','','DACEstructuraPolizaEnc','',1,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHBase_txtMovTo').onchange(); },0); "
                    AutoCallBack="true" OnTextChanged="txtMovTo_Change"></anthem:TextBox>
                    
                       <anthem:ImageButton runat="server" ID="ImageButton7" OnClientClick="var a = JBrowse('ctl00_CPHBase_txtMovTo','','DACEstructuraPolizaEnc','',1,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHBase_txtMovTo').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
        ...
        <tr>
            ...
            <td class="tLetra3" valign="middle" style="width: 600px; height: 25px">
                <%--<anthem:TextBox ID="txtTipoPoliza" runat="server" TabIndex="5" Width="80px" CssClass="String" ondblclick="var a = JBrowse('ctl00_CPHBase_txtTipoPoliza','','DACEstructuraPolizaEnc','',2,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay Tipos de Póliza',1); if(a != undefined) document.getElementById('ctl00_CPHBase_txtTipoPoliza').onchange(); else return false;"--%>
                <anthem:TextBox ID="txtTipoPoliza" runat="server" TabIndex="5" Width="80px" CssClass="String" ondblclick="var a = JBrowse('ctl00_CPHBase_txtTipoPoliza','','DACEstructuraPolizaEnc','',2,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHBase_txtTipoPoliza').onchange(); },0); "
                    AutoCallBack="true" OnTextChanged="txtTipoPoliza_Change"></anthem:TextBox>
                    
                       <anthem:ImageButton runat="server" ID="ImageButton8" OnClientClick="var a = JBrowse('ctl00_CPHBase_txtTipoPoliza','','DACEstructuraPolizaEnc','',2,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHBase_txtTipoPoliza').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
    ...
    <anthem:Panel ID="pnlDetail" runat="server" BackImageUrl="../../../Img/dxpcFooterBack.gif"
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="99%">
            ...
            <tr>
                <td class="tLetra3" style="width: 199px">
                    <%--Cuenta<anthem:TextBox ID="txtCuenta" runat="server" TabIndex="9" Width="100px" AutoCallBack="true" ondblclick="var a = JBrowse('ctl00_CPHBase_txtCuenta','ctl00_CPHBase_txtCuenta,ctl00_CPHBase_hddClaveCuenta','DACEstructuraPolizaDet','',0,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay Cuentas',1); if(a != undefined) document.getElementById('ctl00_CPHBase_txtCuenta').onchange(); else return false;"--%>
                        Cuenta<anthem:TextBox ID="txtCuenta" runat="server" TabIndex="9" Width="100px" AutoCallBack="true" ondblclick="var a = JBrowse('ctl00_CPHBase_txtCuenta','ctl00_CPHBase_txtCuenta,ctl00_CPHBase_hddClaveCuenta','DACCuentas','',1,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHBase_txtCuenta').onchange(); },0); "
                        OnTextChanged="txtCuenta_Change" Style="color: Black; text-align: left; font: 8pt Tahoma;"></anthem:TextBox>
                    <anthem:ImageButton ID="ImageButton9" runat="server" Height="18px" ImageAlign="AbsMiddle" ImageUrl="../../../Img/ayuda.gif" 
                                                                          OnClientClick="var a = JBrowse('ctl00_CPHBase_txtCuenta','ctl00_CPHBase_txtCuenta,ctl00_CPHBase_hddClaveCuenta','DACCuentas','',1,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHBase_txtCuenta').onchange(); },0); " Width="18px" />
            ...
            <tr>
                <td class="tLetra3" style="width: 199px; height: 25px;" colspan="0">
                    &nbsp; &nbsp;Concepto:
                </td>
                <td style="width: 14%">
