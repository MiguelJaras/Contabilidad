        ...
        <tr>      
            ...
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtCuentaFin" runat="server" TabIndex="3" Width="90px" AutoCallBack="true" OnTextChanged="txtCuenta_ChangeFin" Style="color: Black; text-align: left; font: 8pt Tahoma;"></anthem:TextBox>
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton25" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtCuentaFin','ctl00_CPHFilters_txtCuentaFin,ctl00_CPHFilters_txtNombreCuentaFin','DACCuentas','',1,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtClave').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
       ...
       <tr>      
            ...
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtClave" runat="server" OnTextChanged="txtObra_TextChanged" AutoCallBack="true" CssClass="String" MaxLength="50" width="140px" TabIndex="12" >
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton22" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtClave','ctl00_CPHFilters_txtClave,ctl00_CPHFilters_txtNombre','DACPolizaDet','',1,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtClave').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
            ...
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtClaveFin" runat="server" OnTextChanged="txtObraFin_TextChanged" AutoCallBack="true" CssClass="String" MaxLength="50" width="140px" TabIndex="12" >
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton26" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtClaveFin','ctl00_CPHFilters_txtClaveFin,ctl00_CPHFilters_txtNombreFin','DACPolizaDet','',1,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtArea').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
        ...
        <tr>      
            ...
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtArea" runat="server" OnTextChanged="txtArea_TextChanged" AutoCallBack="true" CssClass="String" MaxLength="50" width="90px" TabIndex="12" >
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton23" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtArea','ctl00_CPHFilters_txtArea,ctl00_CPHFilters_txtNombreArea','DACPolizaDet','',2,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtArea').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
            ...
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtAreaFin" runat="server" OnTextChanged="txtAreaFin_TextChanged" AutoCallBack="true" CssClass="String" MaxLength="50" width="90px" TabIndex="12" >
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton27" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtAreaFin','ctl00_CPHFilters_txtAreaFin,ctl00_CPHFilters_txtNombreAreaFin','DACPolizaDet','',2,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtColonia').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
        ...
        <tr>      
            ...
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtColonia" runat="server" OnTextChanged="txtColonia_TextChanged" AutoCallBack="true" CssClass="String" MaxLength="50" width="90px" TabIndex="12" >
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton24" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtColonia','ctl00_CPHFilters_txtColonia,ctl00_CPHFilters_txtColoniaNombre','DACPolizaDet','',3,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtColonia').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
            ...
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtColoniaFin" runat="server" OnTextChanged="txtColoniaFin_TextChanged" AutoCallBack="true" CssClass="String" MaxLength="50" width="90px" TabIndex="12" >
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton28" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtColoniaFin','ctl00_CPHFilters_txtColoniaFin,ctl00_CPHFilters_txtColoniaNombreFin','DACPolizaDet','',3,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtColoniaFin').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
