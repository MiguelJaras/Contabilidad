    ...
    <script type="text/javascript" language="javascript">    
       ...
       function Over(obj) 
        ...
        function Open(tipo, intObra, frente, partida)
        {
            ...
            window.open(url, "", "height=800px width=610px resizable scrollbars");
...
<body >
	...
	<script type="text/javascript" language="javascript">
        ...
        function OpenChild(intTarjeta)
        {
            ...
            window.open("../Catalogos/PUTarjetaPopUP.aspx?page=1&intTarjeta=" + intTarjeta + "&Obra=" + obra, "", "height=900px width=1000px resizable scrollbars");
        }
