...
//        Anthem.Manager.RegisterStartupScript(Page.GetType(), "rpt", "window.showModalDialog('" + url + "','', 'DialogWidth:1000px; DialogHeight:600px;toolbar=no,status=no,scroll=no');", true);        
        Anthem.Manager.RegisterStartupScript(Page.GetType(), "rpt", "window.open('" + url + "','', 'height=1000px width=600px resizable scrollbars');", true);        
    }
    #endregion
    ...
    #region lknBalanzaMensual_Click
    protected void lknBalanzaMensual_Click(object sender, EventArgs e)
    {
        Entity_Conciliaciones obj;
        obj = new Entity_Conciliaciones();
        ...
        query = pol.ExportBalanzaMesual(obj);
