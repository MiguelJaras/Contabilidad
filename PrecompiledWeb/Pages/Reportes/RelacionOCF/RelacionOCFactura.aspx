        ...
        <tr>      
            ...
            <td class="tLetra3" valign="top" style="height: 23px">
                <anthem:TextBox ID="txtProveedor" runat="server" AutoCallBack="true" CssClass="String"
                    MaxLength="50" OnTextChanged="txtProveedor_TextChanged" TabIndex="2" Width="90px"></anthem:TextBox>
                

                       <anthem:ImageButton runat="server" ID="ImageButton21" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtProveedor','ctl00_CPHFilters_txtProveedor,ctl00_CPHFilters_txtNombreProveedor','DACPolizaDet','',8,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtProveedor').focus(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />

                       <anthem:TextBox ID="txtNombreProveedor" runat="server" CssClass="tDatosDisable"
            ...
            <td class="tLetra3" valign="top" style="height: 23px">
                <anthem:TextBox ID="txtProveedorFin" runat="server" AutoCallBack="true" CssClass="String"
                    MaxLength="50" OnTextChanged="txtProveedorFin_TextChanged" TabIndex="3" Width="90px"></anthem:TextBox>
                

                       <anthem:ImageButton runat="server" ID="ImageButton27" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtProveedorFin','ctl00_CPHFilters_txtProveedorFin,ctl00_CPHFilters_txtNombreProveedorFin','DACPolizaDet','',8,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtColonia').focus(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />

                       <anthem:TextBox ID="txtNombreProveedorFin" runat="server" CssClass="tDatosDisable"
                        ReadOnly="True" Width="250px"></anthem:TextBox></td>                
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="tLetra3" valign="top" style="height: 23px">
                <anthem:TextBox ID="txtObraIni" runat="server" AutoCallBack="true" CssClass="String"
                    MaxLength="50" TabIndex="6" Width="90px" OnTextChanged="txtObraIni_TextChanged"></anthem:TextBox>
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton22" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtObraIni','ctl00_CPHFilters_hddIntObraIni,ctl00_CPHFilters_txtObraIni,ctl00_CPHFilters_txtObraIniNombre','DACObra','',0,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtObraIni').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
            ...
            <td class="tLetra3" valign="top" style="height: 23px">
                <anthem:TextBox ID="txtObraFin" runat="server" OnTextChanged="txtObraFin_TextChanged" AutoCallBack="true" CssClass="String" MaxLength="50" width="90px" TabIndex="7" ></anthem:TextBox>
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton28" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtObraFin','ctl00_CPHFilters_hddIntObraFin,ctl00_CPHFilters_txtObraFin,ctl00_CPHFilters_txtObraFinNombre','DACObra','',0,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtOCIni').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
            ...
            <td class="tLetra3" style="height: 23px" valign="top">
                <anthem:TextBox ID="txtOCIni" runat="server" AutoCallBack="true" CssClass="String"
                    MaxLength="50" TabIndex="8" Width="90px" OnTextChanged="txtOCIni_TextChanged"></anthem:TextBox>
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton23" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtOCIni','ctl00_CPHFilters_txtOCIni','DACOrdenCompra','',1,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtOCIni').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
            ...
            <td class="tLetra3" style="height: 23px" valign="top">
                <anthem:TextBox ID="txtOCFin" runat="server" AutoCallBack="true" CssClass="String"
                    MaxLength="50" TabIndex="9" Width="90px"></anthem:TextBox>
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton29" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtOCFin','ctl00_CPHFilters_txtOCFin','DACOrdenCompra','',1,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtAreaIni').focus(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
            ...
            <td class="tLetra3" style="height: 23px" valign="top">
                <anthem:TextBox ID="txtAreaIni" runat="server" AutoCallBack="true" CssClass="String"
                    MaxLength="50" OnTextChanged="txtAreaIni_TextChanged" TabIndex="10" Width="90px"></anthem:TextBox>
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton24" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtAreaIni','ctl00_CPHFilters_txtAreaIni,ctl00_CPHFilters_txtAreaIniNombre','DACArea','',1,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtAreaFin').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
            ...
            <td class="tLetra3" style="height: 23px" valign="top">
                <anthem:TextBox ID="txtAreaFin" runat="server" AutoCallBack="true" CssClass="String"
                    MaxLength="50" OnTextChanged="txtAreaFin_TextChanged" TabIndex="11" Width="90px"></anthem:TextBox>
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton30" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtAreaFin','ctl00_CPHFilters_txtAreaFin,ctl00_CPHFilters_txtAreaFinNombre','DACArea','',1,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtColonia').focus(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
            ...
            <td class="tLetra3" style="height: 23px" valign="top">
                <anthem:TextBox ID="txtColoniaFin" runat="server" AutoCallBack="true" CssClass="String"
                    MaxLength="50" OnTextChanged="txtColoniaFin_TextChanged" TabIndex="13" Width="90px"></anthem:TextBox>
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton31" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtColoniaFin','ctl00_CPHFilters_txtColoniaFin,ctl00_CPHFilters_txtColoniaNombreFin','DACPolizaDet','',3,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtSecIni').focus(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />

                    <anthem:TextBox ID="txtColoniaNombreFin" runat="server" CssClass="tDatosDisable"
            ...
            <td class="tLetra3" style="height: 23px" valign="top">
                <anthem:TextBox ID="txtSecIni" runat="server" AutoCallBack="true" CssClass="String"
                    MaxLength="50" OnTextChanged="txtSecIni_TextChanged" TabIndex="14" Width="90px"></anthem:TextBox>
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton26" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtSecIni','ctl00_CPHFilters_txtSecIni,ctl00_CPHFilters_txtSecIniNombre','DACSector','',0,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtSecIni').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
            ...
            <td class="tLetra3" style="height: 23px" valign="top">
                <anthem:TextBox ID="txtSecFin" runat="server" AutoCallBack="true" CssClass="String"
                    MaxLength="50" OnTextChanged="txtSecFin_TextChanged" TabIndex="15" Width="90px"></anthem:TextBox>
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton32" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtSecFin','ctl00_CPHFilters_txtSecFin,ctl00_CPHFilters_txtSecFinNombre','DACSector','',0,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtSecFin').focus(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
