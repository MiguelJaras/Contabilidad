<%@ Page Language="C#" Culture="Auto" UICulture="Auto" AutoEventWireup="true" MasterPageFile="~/Pages/Reportes/Base.master"
    CodeFile="ERObra.aspx.cs" Inherits="Contabilidad_Compra_Reportes_ER" %>
    ...
    <table>
        ...
        <tr>
            <td class="tLetra3" valign="top" style="height: 23px">
                &nbsp;&nbsp;&nbsp; Obra</td>
            <td class="tLetra3" valign="top" style="height: 23px">
                <anthem:TextBox ID="txtObra" runat="server" AutoCallBack="true" CssClass="String"
                    MaxLength="50" TabIndex="6" Width="150px" OnTextChanged="txtObra_TextChanged"></anthem:TextBox>
       

                       <anthem:ImageButton runat="server" ID="ImageButton22" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtObra','ctl00_CPHFilters_hddIntObra,ctl00_CPHFilters_txtObra,ctl00_CPHFilters_txtObraNombre','DACObra','ctl00_CPHFilters_txtColonia,ctl00_CPHFilters_txtSector',0,0,0,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtObra').onchange(); },1); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />

                <anthem:TextBox ID="txtObraNombre" runat="server" CssClass="tDatosDisable"
                            ReadOnly="True" Width="267px"></anthem:TextBox>
                &nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <div><anthem:HiddenField ID="hddIntObra" runat="server" value ="0"/>
        &nbsp;&nbsp;</div>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="CPHReports" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function Validaciones()
        {
            ...
            var obra = document.getElementById('<%= txtObra.ClientID %>').value.trim();
            ...
            if (!obra) {
                alert("Favor de ingresar Obra");
                document.all('ctl00_CPHFilters_txtObra').focus();
                return false;
            }
            return true;
        }
