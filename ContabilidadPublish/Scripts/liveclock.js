...
//debugger;
    ...
    var myback_color = "Transparent"; //"#E0E0E0";
...
// date to the page.
	//if (ie4||ns6||1==1) { document.write('<span id="LiveClockIE""></span>'); }
...
// The main part of the script:
	...
	// with this, be careful to keep all your quotations in tact.
		...
		//myclock += mypre_text;
		myclock += DaysOfWeek[day]+' '+mday+' de '+MonthsOfYear[month]+' '+yday+' '+' '+'|'+' '+' ';
	...
	// Write the clock to the layer:
		...
		//document.all("LiveClockIE").innerHTML = myclock;
