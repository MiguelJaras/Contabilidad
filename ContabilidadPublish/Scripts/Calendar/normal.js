...
var gcCalBG="#ffffff";	//Nota: cambie el color por BLANCO (#6699cc)AZUL the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="silver";	// the background color of the inner table, showing as a frame.
...
var gsNavPrev="<IMG id='navPrev' class='MonthNav' src='pFirst.PNG' width='22' height='18' border='0' alt='' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<IMG id='navNext' class='MonthNav' src='pLast.PNG' width='22' height='18' border='0' alt='' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator
...
var gcCellBG="";	// Nota: quite los border de las columnas;default background color of the cells. Use "" for transparent!!!
...
var gcToggle="#7093DB";	// the highlight color for the focused cell

var gcFGToday="#A8A8A8";	// the font color for today 
...
var gcBGSelected="#7093DB";	// the background color for the selected date
