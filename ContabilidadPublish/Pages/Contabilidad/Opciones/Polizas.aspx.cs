...
public partial class Administracion_Contabilidad_Polizas : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        txtCuenta.Attributes.Add("ondblclick", "var x=Browse('" + txtCuenta.ClientID + "','" + txtCuenta.ClientID + "," + txtSubCuenta.ClientID + "," + txtSubSubCuenta.ClientID + "," + hddNombreCuenta.ClientID + "," + hddIndAuxiliar.ClientID + "','DACCuentas','',4,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'20', true,'No hay información');");
        txtSubCuenta.Attributes.Add("ondblclick", "var x=Browse('" + txtCuenta.ClientID + "','" + txtCuenta.ClientID + "," + txtSubCuenta.ClientID + "," + txtSubSubCuenta.ClientID + "," + hddNombreCuenta.ClientID + "," + hddIndAuxiliar.ClientID + "','DACCuentas','',4,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'20', true,'No hay información');");
        txtSubSubCuenta.Attributes.Add("ondblclick", "var x=Browse('" + txtCuenta.ClientID + "','" + txtCuenta.ClientID + "," + txtSubCuenta.ClientID + "," + txtSubSubCuenta.ClientID + "," + hddNombreCuenta.ClientID + "," + hddIndAuxiliar.ClientID + "','DACCuentas','',4,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'20', true,'No hay información');");               

        txtObra.Attributes.Add("ondblclick", "var x= Browse('" + txtObra.ClientID + "','" + txtObra.ClientID + "','DACPolizaDet','',5,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'20', true,'No hay información');");
