<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Base.master" CodeFile="CargaPoliza.aspx.cs" Inherits="Contabilidad_Compra_Opciones_CargaPoliza" Culture="auto" UICulture="auto" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td class="tLetra36" style="height: 23px">
                <anthem:DropDownList ID="cboTipoPoliza" runat="server" AutoCallBack="True" CssClass="tDatos150" TabIndex="1" Width="288px">
            ...
            <td align="center">
                <div id="div-ListPanel">
                    <anthem:GridView ID="grdPolizaDet" runat="server" AutoGenerateColumns="false" AutoUpdateAfterCallBack="true"
                        BorderWidth="0" CellPadding="0" CellSpacing="0" CssClass="dxgvTable_Aqua" DataKeyNames="intPartida,Auxiliar"
