    ...
    protected void row_Created(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (dataRowView != null)
            {
                ...
                //lknPoliza.Attributes.Add("onClick", "window.showModalDialog('Polizas.aspx?intEmpresa=" + intEmpresa.ToString() + "&strPoliza=" + poliza + "&intEjercicio=" + intEjercicio + "',null,'dialogHeight:700px; dialogWidth:1000px;status:no;help:no;scroll:no;minimize:no;maximize:no;close:no;border:thin;');  return false;");
