<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Reportes/Base.master" CodeFile="BalanceGral.aspx.cs" Inherits="Contabilidad_Reportes_BalanceGral" %>
                    ...
                    <table width="100%" style="border: Solid 1px #AECAF0;padding: 1px;">                                           
                        <tr>
                            <td onmouseover="Over(this);" onmouseout="Out(this);" class="Out(this);" style="width: 100%; height:20px">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:LinkButton ID="lknBalance" runat="server" OnClientClick="return Review();" Text="Balance General" OnClick="lknBalance_Click" ></asp:LinkButton></td>
                        </tr>                        
                    </table>
                </asp:Panel>
            </td>
