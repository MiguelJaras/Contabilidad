       ...
       <table>
        ...
        <tr>
               ...
               <td class="tLetra3" valign="top">
                   ...
                   <anthem:ImageButton runat="server" ID="btnAyudaPoliza" OnClientClick="var a = Browse('ctl00_CPHFilters_txtPolIni','ctl00_CPHFilters_txtPolIni,ctl00_CPHFilters_hddPoliza,ctl00_CPHFilters_hddPoliza,ctl00_CPHFilters_hddPoliza','DACPolizaDet','ctl00_CPHFilters_cboTipoPoliza,ctl00_CPHFilters_cboYear,ctl00_CPHFilters_cboMonth',4,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información'); if(a != undefined){ document.getElementById('ctl00_CPHFilters_txtPolIni').value = document.getElementById('ctl00_CPHFilters_txtPolIni').value.substring(5); document.getElementById('ctl00_CPHFilters_txtPolFin').focus(); } return false;" height="17" ImageUrl="../../../Img/ayuda.gif" width="20"/> 
               ...
               <td class="tLetra3" valign="top">
                   ...
                   <anthem:ImageButton runat="server" ID="ImageButton1" OnClientClick="var a = Browse('ctl00_CPHFilters_txtPolFin','ctl00_CPHFilters_txtPolFin,ctl00_CPHFilters_hddPolizaFin,ctl00_CPHFilters_hddPolizaFin,ctl00_CPHFilters_hddPolizaFin','DACPolizaDet','ctl00_CPHFilters_cboTipoPolizaFin,ctl00_CPHFilters_cboYear,ctl00_CPHFilters_cboMonth',4,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información'); if(a != undefined) {document.getElementById('ctl00_CPHFilters_txtPolFin').value = document.getElementById('ctl00_CPHFilters_txtPolFin').value.substring(5); document.getElementById('ctl00_CPHFilters_chkAfec').focus(); } return false;" height="17" ImageUrl="../../../Img/ayuda.gif" width="20"/> 
