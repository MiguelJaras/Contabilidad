<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Reportes/Base.master" CodeFile="AuxiliarMensual.aspx.cs" Inherits="Contabilidad_Reportes_AuxiliarMensual" Culture="auto" UICulture="auto" %>
    ...
    <table>
       ...
       <tr>      
        ...
        <tr>      
            ...
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtArea" runat="server" OnTextChanged="txtArea_TextChanged" AutoCallBack="true" CssClass="String" MaxLength="50" width="90px" TabIndex="12" >
                </anthem:TextBox>&nbsp;
                <asp:ImageButton ID="ImageButton8" runat="server" Height="17" ImageUrl="../../../Img/ayuda.gif"
                    OnClientClick="var a = Browse('ctl00_CPHFilters_txtArea','ctl00_CPHFilters_txtArea,ctl00_CPHFilters_txtNombreArea','DACPolizaDet','',2,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay obras'); if (a != undefined) document.getElementById('ctl00_CPHFilters_txtArea').onchange(); return false;"
                    Width="20" />
            ...
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtAreaFin" runat="server" OnTextChanged="txtAreaFin_TextChanged" AutoCallBack="true" CssClass="String" MaxLength="50" width="90px" TabIndex="12" >
                </anthem:TextBox>&nbsp;
                <asp:ImageButton ID="ImageButton9" runat="server" Height="17" ImageUrl="../../../Img/ayuda.gif"
                    OnClientClick="var a = Browse('ctl00_CPHFilters_txtAreaFin','ctl00_CPHFilters_txtAreaFin,ctl00_CPHFilters_txtNombreAreaFin','DACPolizaDet','',2,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay obras'); if (a != undefined) document.getElementById('ctl00_CPHFilters_txtColonia').focus(); return false;"
                    Width="20" />
        ...
        <tr>      
            ...
            <td class="tLetra3" valign="top">
                ...
                <asp:ImageButton ID="ImageButton10" runat="server" Height="17" ImageUrl="../../../Img/ayuda.gif"
            ...
            <td class="tLetra3" valign="top">
                ...
                <asp:ImageButton ID="ImageButton11" runat="server" Height="17" ImageUrl="../../../Img/ayuda.gif"
                    OnClientClick="var a = Browse('ctl00_CPHFilters_txtColoniaFin','ctl00_CPHFilters_txtColoniaFin,ctl00_CPHFilters_txtColoniaNombreFin','DACPolizaDet','',3,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay obras'); if (a != undefined) document.getElementById('ctl00_CPHFilters_txtColoniaFin').focus(); return false;"
                    Width="20" />
        ...
        <tr>
            <td>
                &nbsp;
                <anthem:HiddenField ID="hddIntObraIni" runat="server" />
                <anthem:HiddenField ID="hddIntObraFin" runat="server" />
            </td>
        </tr>        
        <tr>
            <td colspan= "2">
                ...
                <asp:Panel ID="pnlReportes1" runat="server" Visible="True" CssClass="dxnbControl_Aqua" Width="100%">
                    <table width="100%" style="border: Solid 1px #AECAF0;padding: 1px;">                                           
                        <tr>
                         ...
                         <tr>
                            <td onmouseover="Over(this);" onmouseout="Out(this);" class="Out(this);" style="width: 100%; height:19px">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:LinkButton ID="lknAuxiliarINNAUS" runat="server" OnClick="lknAuxiliarINNAUS_Click" Text="Auxiliar INNAUS">
                                </asp:LinkButton>
                                <anthem:CheckBox ID="chkMov" runat="server" Text="Por Movimiento" />
                                <anthem:CheckBox ID="chkHoja" runat="server" Text="Por Hoja" /></td>
                        </tr>                                                                     
                    </table>
                </asp:Panel>
            </td>
