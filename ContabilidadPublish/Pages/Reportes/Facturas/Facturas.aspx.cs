...
public partial class Contabilidad_Compra_Reportes_Facturas : System.Web.UI.Page
{
    ...
    protected void lknFac_Click(object sender, EventArgs e)
    {
        ...
        arrDatos[1] = FechaIni.ToString("dd/MM/yyyy");
        arrDatos[2] = FechaFin.ToString("dd/MM/yyyy");
        ...
        {                                               
            ...
            strQueryString += "&report=Pages/Reportes/Facturas/FacturasElec.rpt";
            strQueryString += "&db=dbFacturas";
