<%@ page language="C#" culture="Auto" uiculture="Auto" autoeventwireup="true" masterpagefile="~/Pages/Reportes/Base.master" CodeFile="Facturas.aspx.cs" inherits="Contabilidad_Compra_Reportes_Facturas" %>
                    ...
                    <table width="100%" style="border: Solid 1px #AECAF0; padding: 1px;">
                        <tr>
                            <td onmouseover="Over(this);" onmouseout="Out(this);" class="Out(this);" style="width: 100%;
                                height: 20px">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <anthem:LinkButton ID="lknFac" runat="server" OnClick="lknFac_Click" Text="Facturas Ingresadas por Portal.">
                                </anthem:LinkButton>
                            </td>
                        </tr>
                    </table>
