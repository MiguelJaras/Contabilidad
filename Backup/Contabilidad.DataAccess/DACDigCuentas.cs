...
{
    public class DACDigCuentas : Base
    {
        #region Fill
        public static DataTable Fill(Entity_DigCuentas obj)
        {
            DataSet ds;
            ...
            try
            {
                ds = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "dbDigitalizacion.dbo.usp_tbDigCuentas_Fill", arrPar);
                return ds.Tables[0];
            }
            catch (Exception e)
            {
		...
		#region Save
        public static string Save(Entity_DigCuentas obj)
        {
            string bResult;
            ...
            try
            {
                bResult = SqlHelper.ExecuteScalar(ConnectionString, CommandType.StoredProcedure, "dbDigitalizacion.dbo.usp_tbDigCuentas_Save", arrPar).ToString();
            }
            catch (Exception e)
            {
                throw e;
