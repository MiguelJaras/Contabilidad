        ...
        <tr>
         ...
         <tr>
            <td class="tLetra3" valign="top">
                &nbsp;&nbsp; Cuenta Bancaria</td>
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtCtaBanc" runat="server" AutoPostBack="true" CssClass="String" TabIndex="3" Width="80px" OnTextChanged="txtCta_TextChanged" ></anthem:TextBox>&nbsp;<anthem:ImageButton
                    ID="ImageButton4" runat="server" Height="17" ImageUrl="../../../Img/ayuda.gif"
                    OnClientClick="var a = Browse('ctl00_CPHFilters_txtCtaBanc','ctl00_CPHFilters_txtCtaBanc,ctl00_CPHFilters_txtCtaBancDes','DACFactura','',18,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información'); if(a != undefined) document.getElementById('ctl00_CPHFilters_Label1').focus(); return false;"
                    Width="20" />
