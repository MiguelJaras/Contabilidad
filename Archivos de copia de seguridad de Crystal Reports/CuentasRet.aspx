    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td class="tLetra36">
                ...
                <anthem:ImageButton runat="server" ID="imgArea" ImageAlign="AbsMiddle" OnClientClick="var a = Browse('ctl00_CPHBase_txtArea','ctl00_CPHBase_txtArea,ctl00_CPHBase_txtNombreArea','DACArea','',1,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',1); if(a != undefined) document.getElementById('ctl00_CPHBase_txtArea').onchange(); return false;"
        ...
        <tr>
            ...
            <td class="tLetra36">
                ...
                <anthem:ImageButton runat="server" ID="imgInsumoIni" ImageAlign="AbsMiddle" OnClientClick="var a = Browse('ctl00_CPHBase_txtInsumoIni','ctl00_CPHBase_txtInsumoIni,ctl00_CPHBase_txtNombreInsumoIni','DACArticulo','',4,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',1); if(a != undefined) document.getElementById('ctl00_CPHBase_txtInsumoIni').onchange(); return false;"
                    Height="17" ImageUrl="../../../Img/ayuda.gif" Width="20" />
            ...
            <td class="tLetra36">
                ...
                <anthem:ImageButton runat="server" ID="imgCtaCargo" ImageAlign="AbsMiddle" OnClientClick="var a = Browse('ctl00_CPHBase_txtCtaCargo','ctl00_CPHBase_txtCtaCargo,ctl00_CPHBase_txtNombreCtaCargo','DACCuentas','',1,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',1); if(a != undefined) document.getElementById('ctl00_CPHBase_txtCtaAbono').focus(); return false;"
                    Height="17" ImageUrl="../../../Img/ayuda.gif" Width="20" />
        ...
        <tr>
            ...
            <td class="tLetra36">
                ...
                <anthem:ImageButton runat="server" ID="imgInsumoFin" ImageAlign="AbsMiddle" OnClientClick="var a = Browse('ctl00_CPHBase_txtInsumoFin','ctl00_CPHBase_txtInsumoFin,ctl00_CPHBase_txtNombreInsumoFin','DACArticulo','',4,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',1); if(a != undefined) document.getElementById('ctl00_CPHBase_txtCtaCargo').focus(); return false;"
                    Height="17" ImageUrl="../../../Img/ayuda.gif" Width="20" />
            ...
            <td class="tLetra36">
                ...
                <anthem:ImageButton runat="server" ID="imgCtaAbono" ImageAlign="AbsMiddle" OnClientClick="var a = Browse('ctl00_CPHBase_txtCtaAbono','ctl00_CPHBase_txtCtaAbono,ctl00_CPHBase_txtNombreCtaAbono','DACCuentas','',1,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',1); if(a != undefined) document.getElementById('ctl00_CPHBase_btnBuscar').focus(); return false;"
                    Height="17" ImageUrl="../../../Img/ayuda.gif" Width="20" />
