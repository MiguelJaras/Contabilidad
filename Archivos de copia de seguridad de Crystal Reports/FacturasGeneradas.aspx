<%@ page language="C#" culture="Auto" uiculture="Auto" autoeventwireup="true" masterpagefile="~/Pages/Reportes/Base.master" CodeFile="FacturasGeneradas.aspx.cs" inherits="Contabilidad_Compra_Reportes_FacturasGeneradas" %>
                    ...
                    <table width="100%" style="border: Solid 1px #AECAF0; padding: 1px;">
                        <tr>
                            <td onmouseover="Over(this);" onmouseout="Out(this);" class="Out(this);" style="width: 100%;
                                height: 20px">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <anthem:LinkButton ID="lknFac" runat="server" OnClick="lknFac_Click" Text="Facturas Generadas"></anthem:LinkButton>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
