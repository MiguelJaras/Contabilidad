...
<asp:Content ID="Content" ContentPlaceHolderID="CPHFilters" runat="Server">
    ...
    <table>
        ...
        <tr>      
            ...
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtClave" runat="server"  AutoCallBack="true" CssClass="String" MaxLength="50" width="140px" TabIndex="3" OnTextChanged="txtObra_TextChanged" ></anthem:TextBox><asp:ImageButton ID="ImageButton4" runat="server" Height="17" ImageUrl="../../../Img/ayuda.gif"
                    ...
                    Width="20" /><anthem:TextBox ID="txtNombre" runat="server"  CssClass="tDatosDisable" width="220px" ReadOnly="True"></anthem:TextBox>                                
            </td>
            <td class="tLetra3" valign="top">
                Obra Final
            </td>                
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtClaveFin" runat="server" OnTextChanged="txtObraFin_TextChanged" AutoCallBack="true" CssClass="String" MaxLength="50" width="140px" TabIndex="4" ></anthem:TextBox><asp:ImageButton
                    ...
                    Width="20" /><anthem:TextBox ID="txtNombreFin" runat="server"  CssClass="tDatosDisable" width="220px" ReadOnly="True"></anthem:TextBox>                                  
            </td>                
        </tr>
        <tr>      
            <td class="tLetra3" valign="top">
            ...
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtColonia" runat="server" OnTextChanged="txtColonia_TextChanged" AutoCallBack="true" CssClass="String" MaxLength="50" width="90px" TabIndex="5" ></anthem:TextBox><asp:ImageButton ID="ImageButton2" runat="server" Height="17" ImageUrl="../../../Img/ayuda.gif"
                    ...
                    Width="20" /><anthem:TextBox ID="txtColoniaNombre" runat="server"  CssClass="tDatosDisable" width="267px" ReadOnly="True"></anthem:TextBox>                                
            </td>
            <td class="tLetra3" valign="top">
                Colonia Final
            </td>                
            <td class="tLetra3" valign="top">
                <anthem:TextBox ID="txtColoniaFin" runat="server" OnTextChanged="txtColoniaFin_TextChanged" AutoCallBack="true" CssClass="String" MaxLength="50" width="90px" TabIndex="6" ></anthem:TextBox><asp:ImageButton
                    ID="ImageButton5" runat="server" Height="17" ImageUrl="../../../Img/ayuda.gif"
