    ...
    protected void DgrdList_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        {//#FFA07A
            ...
            {                
                ...
                lknCargos.Attributes.Add("onClick", "window.open('" + url + "&intCargo=1" + "',null,'height=600px width=800px resizable scrollbars');  return false;");
                ...
                lknAbonos.Attributes.Add("onClick", "window.open('" + url + "&intCargo=0" + "',null,'height=600px width=800px resizable scrollbars');  return false;");
