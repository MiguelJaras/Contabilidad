        ...
        <tr>      
           ...
           <tr>
               ...
               <td class="tLetra3" valign="top" style="width: 470px">
                   <anthem:TextBox ID="txtClave" runat="server" AutoPostBack="true" CssClass="String" TabIndex="3" Width="140px" OnTextChanged="txtObra_TextChanged"></anthem:TextBox> 

                       <anthem:ImageButton runat="server" ID="ImageButton8" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtClave','ctl00_CPHFilters_txtNombre','DACPolizaDet','',1,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_txtClave').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />

                   <anthem:TextBox ID="txtNombre" runat="server" CssClass="String"
                               Width="300px" TabIndex="4"></anthem:TextBox></td>
               <td class="tLetra3" valign="top">
                   Obra Final</td>
               <td class="tLetra3" valign="top" style="width: 470px">
                   <anthem:TextBox ID="txtClaveFin" runat="server" AutoPostBack="true" CssClass="String" TabIndex="3" Width="140px" OnTextChanged="txtObraFin_TextChanged"></anthem:TextBox> 

                       <anthem:ImageButton runat="server" ID="ImageButton9" OnClientClick="var a = JBrowse('ctl00_CPHFilters_txtClaveFin','ctl00_CPHFilters_txtClaveFin,ctl00_CPHFilters_txtNombreFin','DACPolizaDet','',1,ctl00_CPHFilters_txtEmpresa.value,ctl00_CPHFilters_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHFilters_lknEstado').focus(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />

                   <anthem:TextBox ID="txtNombreFin" runat="server" CssClass="String" TabIndex="4" Width="300px"></anthem:TextBox></td>
           </tr>
    </table>
</asp:Content>
