        ...
        <tr>
            ...
            <td class="tLetra36" style="height: 23px">
                <anthem:TextBox ID="txtRubro" runat="server" AutoCallBack="true" CssClass="String" TabIndex="1" Width="80px" OnTextChanged="txtRubro_TextChanged"></anthem:TextBox>
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton8" OnClientClick="var a = JBrowse('ctl00_CPHBase_txtRubro','ctl00_CPHBase_txtRubro,ctl00_CPHBase_txtNombre','DACRubros','',0,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHBase_txtCuenta').focus(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
        ...
        <tr>
            ...
            <td class="tLetra36" style="height: 23px">
                <anthem:TextBox ID="txtCuenta" runat="server" AutoCallBack="true" CssClass="String"
                    ...
                    TabIndex="2" Width="80px"></anthem:TextBox>&nbsp;<anthem:ImageButton runat="server" ID="ImageButton9" OnClientClick="var a = JBrowse('ctl00_CPHBase_txtCuenta','ctl00_CPHBase_txtCuenta,ctl00_CPHBase_txtCuentaDes','DACCuentas','',1,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHBase_txtCuenta').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
