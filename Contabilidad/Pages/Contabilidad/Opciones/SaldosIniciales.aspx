<%@ Page Language="C#" MasterPageFile="~/Pages/Contabilidad/Opciones/Base.master"
    AutoEventWireup="true" CodeFile="SaldosIniciales.aspx.cs" Inherits="Pages_Opciones_SaldosIniciales" culture="es-mx" uiculture="es"
    Title="Untitled Page" %>
            ...
            <td class="tLetra36">
                <anthem:TextBox ID="txtCuenta" runat="server" TabIndex="2" Width="90px" AutoCallBack="true"
                    OnTextChanged="txtCuenta_Change" Style="color: Black; text-align: left; font: 8pt Tahoma;"></anthem:TextBox>
                       ...
                       <anthem:ImageButton runat="server" ID="ImageButton7" OnClientClick="var a = JBrowse('ctl00_CPHBase_txtCuenta','ctl00_CPHBase_txtCuenta,ctl00_CPHBase_txtNombreCuenta','DACCuentas','',1,ctl00_CPHBase_txtEmpresa.value,ctl00_CPHBase_hddSucursal.value,'8', true,'No hay información',function(){document.getElementById('ctl00_CPHBase_txtCuenta').onchange(); },0); "
                    Height="18px" ImageUrl="../../../Img/ayuda.gif" Width="20" ImageAlign="AbsMiddle" />
