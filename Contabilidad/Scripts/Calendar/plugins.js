...
// NOTE: DO NOT define this handler unless you really need to use it.
////////////////////////////////////////////////////////////////////
 function fAfterSelected(y,m,d,e) { Reload(); }

 function Reload()
 {
    if(window.parent.document.getElementById('ctl00_CPHBase_txtFechaInicial') != null)
        window.parent.document.getElementById('ctl00_CPHBase_txtFechaInicial').onchange();
 }
...
// NOTE: DO NOT define this handler unless you really need to use it.
////////////////////////////////////////////////////////////////////
 //function fOnWeekClick(year, weekNo) {alert('Here');}
