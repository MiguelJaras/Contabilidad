...
{   
	...
	var _rowclick = null;
	 ...
	 for (var j=1;j<_grid.rows.length;j++) { 
		...
		if (rowclick.rowIndex % 2)
		    ...
		    rowclick.runtimeStyle.backgroundColor = '#EBEADB';//CSTALTERTABLECOLOR;
	}
	...
	this.setRow=function(intRow){		
		if (_rowclick == null) 
			...
			if(_rowover.rowIndex%2)
			    ...
			    _rowover.runtimeStyle.backgroundColor = '#EBEADB';// CSTALTERTABLECOLOR;
		...
		if (intRow!=0)			
		    _rowclick.runtimeStyle.backgroundColor = '#6699FC';//CSTCOLORCLICK;		
	}
	...
	click=function(){
		...
		if (_rowclick != null) 
			if(_rowclick.rowIndex%2)
			    ...
			    _rowclick.runtimeStyle.backgroundColor = '#EBEADB';// CSTALTERTABLECOLOR;
		//Asigno el estilo a la nueva fila
		//srcTag.runtimeStyle.backgroundColor = '#6699FC'; //CSTCOLORCLICK;
	...
	dobleclick=function(){
		...
		if (_rowclick != null) 
			if(_rowclick.rowIndex%2)
			    _rowclick = srcTag;	//_rowclick.runtimeStyle.backgroundColor = '#FFFFFF';	
			else
			    _rowclick = srcTag;	//_rowclick.runtimeStyle.backgroundColor = '#EBEADB';//CSTALTERTABLECOLOR;
		//Asigno el estilo a la nueva fila
		//srcTag.runtimeStyle.backgroundColor = '#6699FC';//CSTCOLORCLICK;
		//Guardo la fila que actualmente esta seleccionada
		_rowclick = srcTag;	
	...
	function _showover(newRow){
		...
		if (newRow != null && newRow!=_rowclick)
		    //newRow.runtimeStyle.backgroundColor = '#6699FC';// CSTCOLOROVER;
		_rowover = newRow;	
